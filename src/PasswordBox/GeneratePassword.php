...
final class GeneratePassword
{
    ...
    private static array $switch = [
        'm' => ['a', 'b', 'c', 'd', 'e', 'f', 'g', 'h', 'i', 'j', 'k', 'l', 'm', 'n', 'o', 'p', 'q', 'r', 's', 't', 'u', 'v', 'w', 'x', 'y', 'z', 'o', '1', '2', 'e', ' a', ' 5', ' 6', ' 7', '8', '9', ' '],
        'd' => ['4', '8', 'c', 'd', '3', 'f', '6', 'h', '9', 'j', 'k', '1', 'm', 'n', '0', 'p', '9', 'r', '5', 't', 'u', 'v', 'w', 'x', 'y', '2', 'o', 'l', '2', 'e', 'a', 's', 'g', '7', 'b', 'i', '_'],
        's1' => ['@', 'b', 'c', 'd', 'e', 'f', 'g', 'h', '!', 'j', 'k', 'l', 'm', 'n', 'o', 'p', 'q', 'r', '$', 't', 'u', 'v', 'w', 'x', 'y', 'z', '0', 'l', '2', 'e', '4', '5', '6', '7', ':', '9', '-'],
        's2' => ['^', 'b', 'c', 'd', 'e', 'f', 'g', 'h', 'i', 'j', 'k', 'l', 'm', 'n', 'o', 'p', 'q', 'r', 's', 't', 'u', 'v', 'w', 'x', 'y', 'z', 'o', 'l', '2', '3', 'a', 's', 'g', '7', '8', '9', ' '],
    ];
