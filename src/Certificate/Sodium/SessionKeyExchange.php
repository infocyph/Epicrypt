...
final class SessionKeyExchange implements KeyExchangeInterface
{
    ...
    public function deriveSharedSecret(
        ...
        return $this->derive($privateKey, $publicKey, false);
    }
    ...
    public function deriveSharedSecretFromBinaryKeys(
        ...
        return $this->derive($privateKey, $publicKey, true);
    }
    ...
    private function validateKxInputs(#[\SensitiveParameter] string $keyPair, string $peerPublicKey): void
    {
