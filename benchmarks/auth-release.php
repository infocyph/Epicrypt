...
$patIssue = $patManager->issue('bench-user', 'release-bench', ['orders:read']);
...
echo json_encode($evidence, JSON_PRETTY_PRINT | JSON_THROW_ON_ERROR | JSON_UNESCAPED_SLASHES), PHP_EOL;
